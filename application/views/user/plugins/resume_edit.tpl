...
<table border="0" cellpadding="0" cellspacing="0" class="style1">
	...
	<tr>
		...
		echo sprintf('<div id="%d-skill" class="li"><a href="%s" onclick="$(\'#%d-skill\').slideUp(); $(\'#%d-skill-form\').slideDown();return false;">%s</a></div>',
			$skill['id'],
			site_url('plugins/idslot_resume/edit_skill/' . $skill['id']),
			$skill['id'],
			$skill['id'],
			$skill['title']
		);
		echo form_open_multipart('plugins/idslot_resume/edit_skill/' . $skill['id']); 
		?>
		  <div class="subfieldset SkillDiv" style="display:none;" id="<?php echo $skill['id'] . '-skill-form'; ?>">
			...
			<div class="submit">
				<label></label><a class="button form-delete" href="<?php echo site_url('plugins/idslot_resume/remove_skill/' . $skill['id']) ?>" onclick="return confirm('<?php echo lang('Are you sure to delete this skill?') ?>');"><?php echo lang('Delete'); ?></a><input type="submit" name="submit" value="<?php echo lang('Edit'); ?>" class="form-submit" />
			</div>
...
<?php
echo form_open_multipart('plugins/idslot_resume/add_skill/'); 
?>
...
<table border="0" cellpadding="0" cellspacing="0" class="style1">
	...
	<tr>
		...
		echo sprintf('<div id="%d-education" class="li"><a href="%s" onclick="$(\'#%d-education\').slideUp(); $(\'#%d-education-form\').slideDown();return false;">%s</a></div>',
			$education['id'],
			site_url('plugins/idslot_resume/edit_education/' . $education['id']),
			$education['id'],
			$education['id'],
			$education['summary']
		);
		echo form_open_multipart('plugins/idslot_resume/edit_education/' . $education['id']); 
		?>
		...
		<div class="submit">
			<label></label><a class="button form-delete" href="<?php echo site_url('plugins/idslot_resume/remove_education/' . $education['id']) ?>" onclick="return confirm('<?php echo lang('Are you sure to delete this education?') ?>');"><?php echo lang('Delete'); ?></a><input type="submit" name="submit" value="<?php echo lang('Edit'); ?>" class="form-submit" />
		</div>
...
<?php
echo form_open_multipart('plugins/idslot_resume/add_education/'); 
?>
...
<table border="0" cellpadding="0" cellspacing="0" class="style1">
	...
	<tr>
		...
		echo sprintf('<div id="%d-experience" class="li"><a href="%s" onclick="$(\'#%d-experience\').slideUp(); $(\'#%d-experience-form\').slideDown();return false;">%s</a></div>',
			$experience['id'],
			site_url('plugins/idslot_resume/edit_experience/' . $experience['id']),
			$experience['id'],
			$experience['id'],
			$experience['summary']
		);
		echo form_open_multipart('plugins/idslot_resume/edit_experience/' . $experience['id']); 
		?>
		...
		<div class="submit">
			<label></label><a class="button form-delete" href="<?php echo site_url('plugins/idslot_resume/remove_experience/' . $experience['id']) ?>" onclick="return confirm('<?php echo lang('Are you sure to delete this experience?') ?>');"><?php echo lang('Delete'); ?></a><input type="submit" name="submit" value="<?php echo lang('Edit'); ?>" class="form-submit" />
		</div>
		</div>
		</form>
		</td>
...
<?php
echo form_open_multipart('plugins/idslot_resume/add_experience/'); 
?>
...
<table border="0" cellpadding="0" cellspacing="0" class="style1">
	...
	<tr>
		...
		echo sprintf('<div id="%d-publication" class="li"><a href="%s" onclick="$(\'#%d-publication\').slideUp(); $(\'#%d-publication-form\').slideDown();return false;">%s</a></div>',
			$publication['id'],
			site_url('plugins/idslot_resume/edit_publication/' . $publication['id']),
			$publication['id'],
			$publication['id'],
			$publication['title']
		);
		echo form_open_multipart('plugins/idslot_resume/edit_publication/' . $publication['id']); 
		?>
		...
		<div class="submit">
			<label></label><a class="button form-delete" href="<?php echo site_url('plugins/idslot_resume/remove_publication/' . $publication['id']) ?>" onclick="return confirm('<?php echo lang('Are you sure to delete this publication?') ?>');"><?php echo lang('Delete'); ?></a><input type="submit" name="submit" value="<?php echo lang('Edit'); ?>" class="form-submit" />
		</div>
...
<?php
echo form_open_multipart('plugins/idslot_resume/add_publication/'); 
?>
