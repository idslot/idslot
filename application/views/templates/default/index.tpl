...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    if (lang('direction') == 'rtl')
      echo '<link href="application/views/idslot/theme/styles/rtl.css" type="text/css" rel="stylesheet" />';
    ?>
      ...
      <div class="cornerBoxInner">
        ...
        <div class="maincontent idslot">
          ...
          <div class="navigation">
            ...
            if ($has_resume) {
              if(file_exists("application/views/idslot/files/resume/$uid.pdf")){
                $rtype = '.pdf';
              }else{
                $rtype = '.html';
              }
              ?>
              <span class="item"><a href="application/views/idslot/files/resume/<?php echo $uid . $rtype; ?>" target="blank"><?php echo lang('Resume'); ?></a></span>
              <?php
            }
            ?>
          </div>
